import { config as unoConfig } from "/package_d5f9c420dfe3debd5fc1ad4081ab52fd359e5930/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('6fcc819b-3b38-4b72-ae63-28710d6be965').then(async function (cache) {
                ...
                try {
                    ...
                    const response = await fetch("/_framework/dotnet.boot.js");
                    if (!response.ok) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '6fcc819b-3b38-4b72-ae63-28710d6be965';
